...
metrics = {
    ...
    'front_bound%': ('100 * self.idq_uops_not_delivered.core'
    ...
    'l3_latency%': ('(41 * ( self.mem_load_uops_retired.l3_hit_ps'
                    ...
                    'self.mem_load_uops_l3_miss_retired.local_dram_ps +'
                    'self.mem_load_uops_l3_miss_retired.remote_dram_ps +'
                    'self.mem_load_uops_l3_miss_retired.remote_hitm_ps +'
                    'self.mem_load_uops_l3_miss_retired.remote_fwd_ps)))'
                    '/self.cpu_clk_unhalted.thread)'),
    'l3_latency.contribution%': (
        '(41 * ( self.mem_load_uops_retired.l3_hit_ps'
        '* (1 + self.mem_load_uops_retired.hit_lfb_ps / '
        '((self.mem_load_uops_retired.l2_hit_ps +'
        'self.mem_load_uops_retired.l3_hit_ps +'
        'self.mem_load_uops_l3_hit_retired.xsnp_hit_ps +'
    ...
    'l3_data_sharing.contribution%': (
        ...
        'self.mem_load_uops_l3_miss_retired.remote_fwd_ps)))/'
        'total.cpu_clk_unhalted.thread)'),
    'l3_contested_accesses%': (
        '(60 * ((self.mem_load_uops_l3_hit_retired.xsnp_hitm_ps '
        '* (1 + self.mem_load_uops_retired.hit_lfb_ps '
        '/((self.mem_load_uops_retired.l2_hit_ps +'
        'self.mem_load_uops_retired.l3_hit_ps +'
        'self.mem_load_uops_l3_hit_retired.xsnp_hit_ps +'
        ...
        'self.mem_load_uops_l3_miss_retired.remote_fwd_ps))))'
        '/ self.cpu_clk_unhalted.thread)'),
    'l3_contested_accesses.contribution%': (
        '(60 * ((self.mem_load_uops_l3_hit_retired.xsnp_hitm_ps '
        '* (1 + self.mem_load_uops_retired.hit_lfb_ps '
        '/((self.mem_load_uops_retired.l2_hit_ps +'
        'self.mem_load_uops_retired.l3_hit_ps +'
        ...
        'self.mem_load_uops_l3_miss_retired.remote_fwd_ps))))'
        '/ total.cpu_clk_unhalted.thread)'),
    'store_bound%': ('100 * self.resource_stalls.sb '
                     '/ self.cpu_clk_unhalted.thread'),
    'store_bound.contribution%': ('100 * self.resource_stalls.sb'
                                  '/ total.cpu_clk_unhalted.thread'),
    'local_dram_bound%': (
        '100 * (200 * (self.mem_load_uops_l3_miss_retired.local_dram_ps '
        '* (1 + self.mem_load_uops_retired.hit_lfb_ps'
        '/((self.mem_load_uops_retired.l2_hit_ps +'
        'self.mem_load_uops_retired.l3_hit_ps +'
        'self.mem_load_uops_l3_hit_retired.xsnp_hit_ps +'
    ...
    'local_dram_bound.contribution%': (
        ...
        'total.cpu_clk_unhalted.thread)'),
    'remote_dram_bound%': (
        '100 * (310 * (self.mem_load_uops_l3_miss_retired.remote_dram_ps '
        '* (1 + self.mem_load_uops_retired.hit_lfb_ps'
        '/((self.mem_load_uops_retired.l2_hit_ps'
        '+ self.mem_load_uops_retired.l3_hit_ps'
        '+ self.mem_load_uops_l3_hit_retired.xsnp_hit_ps'
        ...
        '+ self.mem_load_uops_l3_miss_retired.remote_fwd_ps)))'
        '/ self.cpu_clk_unhalted.thread)'),
    'remote_dram_bound.contribution%': (
        '100 * (310 * (self.mem_load_uops_l3_miss_retired.remote_dram_ps '
        '* (1 + self.mem_load_uops_retired.hit_lfb_ps'
        '/((self.mem_load_uops_retired.l2_hit_ps'
        '+ self.mem_load_uops_retired.l3_hit_ps'
    ...
    'be_bound_at_exe%': ('100 * (self.cycle_activity.cycles_no_execute '
                         ...
                         '/ (self.cpu_clk_unhalted.thread)'),
    'resource_stalls_cost%': ('100 * self.resource_stalls.any '
                              '/ self.cpu_clk_unhalted.thread'),
...
def evaluate_metric(header, data, dict_name, name, expression):
    ...
    for task in sorted(data.keys()):
        ...
        for h in sorted(header, reverse=True):
            ...
            # print(h, string)
        try:
            val = round(eval(string.lower()), 3)
            if val < 0:
                print('---------------')
                print('[%s:%s]: Produced negative value (setting to zero)' %
                      (name, task))
                print('---------------')
                val = 0
